...
<form name="storyHead" id="storyHead" method="post">
    ...
    <div class="row my-3">
        <div class="col">
            ...
            {
                ?>
                <a href="Testimonial copy.php?page=<?php echo 1; ?>"><p class="text-center">&laquo; Previous</p></a>
                <?php
            }
            ?>
        </div>
        ...
        {
            echo '<a style="padding-left: 100px;" href="Testimonial copy.php?page=' . $p . '">' . $p . '</a> ';
        }
        ?>
        <div class="col">
            <?php
            ...
            {
                ?>
                <a href="Testimonial copy.php?page=<?php echo ($page + 1);?>"><p class='text-center'>Next &raquo;</p></a>
                <?php
            }
            ?>
        </div>
